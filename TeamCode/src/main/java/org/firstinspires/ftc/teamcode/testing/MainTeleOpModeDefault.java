...
@Disabled
@Config
@TeleOp(name = "Default", group = "OpMode")
public class MainTeleOpModeDefault extends CommandOpMode {
    ...
    public void initialize() {
        ...
        //swerve = new DrivetrainSubsystem(hardware, telemetry, file.pullModuleAngleOffsets(), file.getRobotHeadingOffset(), false);
